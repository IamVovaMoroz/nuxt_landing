...
const features = [
  ...
  {
    title: "Open-Source Self-Maintenance",
    description:
...
<template>
  <div class="mt-16 md:mt-0">
    <h2 class="text-4xl lg:text-5xl font-bold lg:tracking-tight mb-8">
      How QELOS Enhances Your SaaS Development Experience
    </h2>


    <img class="w-full h-96 " src="~/assets/img/3.jpg" alt="server image" loading="eager" format="avif" width="1920"
      height="1080" />


    <div class="grid sm:grid-cols-2 md:grid-cols-3 mt-8 gap-8 fade-in-container">
      <div v-for="(item, index) in features" :key="index" :style="{ '--index': index }" class="fade-in card">
        <div class="flex gap-4 items-start p-[10px]">
